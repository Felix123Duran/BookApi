using MyRepository = Bookapp.Administration.Repositories.UserPermissionRepository;
using MyRow = Bookapp.Administration.UserPermissionRow;

namespace Bookapp.Administration.Endpoints;
